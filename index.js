...
// ===============================
// Persistent storage - more robust
// ===============================
...
function loadLinkedDrivers() {
  try {
    ...
    console.log("[STORAGE] Raw file size:", raw.length);
...
// ... (maskSecret, getValidAccessToken, getCurrentIRating remain the same)
...
// Callback - robust save with logging
